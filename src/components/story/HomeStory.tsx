 ...
 * chapter, and the closing call-to-action. Tracks which chapter is centred in
 * the viewport (for the header kicker + progress counter) with a single
 * IntersectionObserver — no scroll hijacking. Chapter type theme (light/dark)
 * is computed here so it is stable between server and client renders.
 */
