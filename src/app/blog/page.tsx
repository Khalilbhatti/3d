...
export const metadata = pageMetadata({
  title: "Blog",
  description:
    "Strategy and field notes from the GitzTech team on AI automation, n8n, RAG, CRM, WhatsApp automation and AI agents.",
  path: "/blog",
});
    ...
    <>
      ...
      <div className="container-editorial pb-28">
        {hasMultipleCategories ? (
          <>
            <SectionDivider label="Browse by category" className="mb-8" labelAs="h2" />
        ...
        {feature ? (
          <>
            <SectionDivider label="Latest" className={hasMultipleCategories ? "mb-12 mt-20" : "mb-12"} labelAs="h2" />
        ...
        {rest.length ? (
          <>
            <SectionDivider label="More from the blog" className="mb-12" labelAs="h2" />
